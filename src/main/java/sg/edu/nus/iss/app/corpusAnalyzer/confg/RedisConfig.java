package sg.edu.nus.iss.app.corpusAnalyzer.confg;
...
public class RedisConfig {
    ...
    //@Bean is a Spring Framework annotation used to indicate that a method 
    //is used to configure and create a Spring managed bean instance.
    @Bean
    @Primary
    @Scope("singleton")
